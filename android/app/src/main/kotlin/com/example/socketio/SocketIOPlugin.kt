 ...
 * SocketIOPlugin
 */
public class SocketIOPlugin implements MethodCallHandler {

    private Map<Integer, AdharaSocket> instances;
    private int currentIndex;
//    private final MethodChannel channel;
    private final Registrar registrar;
    private static final String TAG = "SocketIOPlugin";
    ...
    private SocketIOPlugin(Registrar registrar/*, MethodChannel channel*/) {
...
//        this.channel = channel;
    ...
    public static void registerWith(Registrar registrar) {
        ...
        channel.setMethodCallHandler(new SocketIOPlugin(registrar/*, channel*/));
    }
            ...
            case "newInstance": {
                try{
                    ...
                    try {
                        ...
                        if (transports != null) {
                            options.transports = SocketIOPlugin.getStringArray(transports);
                        }
